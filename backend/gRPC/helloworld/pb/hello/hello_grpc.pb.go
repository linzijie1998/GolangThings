...
func (c *helloServiceClient) SayHello(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Resp, error) {
	out := new(Resp)
...
func (UnimplementedHelloServiceServer) SayHello(context.Context, *Req) (*Resp, error) {
